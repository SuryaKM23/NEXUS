            ...
            <div class="row">
                ...
                <div class="col-md-3 text-end">
                    ...
                    <p class="d-flex text-center justify-content-end">
                        <a href="#" id="linkedin" target="_blank" class="mt-2">
    ...
    <div class="container pt-0">
        <div class="row">
            ...
            <div class="col-md-8 pe-5">
                <p id="description" class="section-content text-justify"></p>
            ...
            success: function(response) {
                if (response.profile) {
                    ...
                    if (response.profile.linkedin_id) {
                        $('#linkedin').attr('href', response.profile.linkedin_id).show();
                    } else {
                        $('#linkedin').hide();
                    }
